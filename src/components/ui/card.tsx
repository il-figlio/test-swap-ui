...
interface CardProps extends React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement>> {
  className?: string;
}
...
const CardTitle = React.forwardRef<HTMLHeadingElement, CardProps>(({ className, children, ...props }, ref) => (
  <h3
    ref={ref}
...
const CardDescription = React.forwardRef<HTMLParagraphElement, CardProps>(({ className, children, ...props }, ref) => (
  <p
    ref={ref}
